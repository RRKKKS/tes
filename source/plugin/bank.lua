...
local t = '*◍ عشان تسوي حساب لازم تختار نوع البطاقة*\n\n[🎮 َِ𝙒َِ𝘦َِ𝙇َِ𝙘َِ𝘰َِ𝘮َِ𝘦 َِ𝙏َِ𝘰 َِ𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌](t.me/RB_RO )'
...
send(msg.chat_id,msg.id, "*◍ حوالة صادرة من بنك فينوم\n\n◍ المرسل ⇿ "..news.."\n◍ الحساب رقم ⇿* `"..cccc.."`\n*◍ نوع البطاقة ⇿ "..uuuu.."\n◍ المستلم ⇿ "..newss.."\n◍ الحساب رقم ⇿* `"..text.."`\n*◍ نوع البطاقة ⇿ "..fsvhh.."\n◍ خصمت 10% رسوم تحويل\n◍ المبلغ ⇿ "..convert_mony.." جنيه 💵 *","md",true)
send(fsvhhh,0, "*◍ حوالة واردة من بنك فينوم\n\n◍ المرسل ⇿ "..news.."\n◍ الحساب رقم ⇿* `"..cccc.."`\n*◍ نوع البطاقة ⇿ "..uuuu.."\n◍ المبلغ ⇿ "..convert_mony.." جنيه 💵 *","md",true)
Redis:del(Fast.."trans" .. msg.chat_id .. ":" .. senderr) 
Redis:del(Fast.."transn" .. senderr)
else
send(msg.chat_id,msg.id, "*◍ مافيه حساب بنكي كذا *","md",true)
