...
chdevolper = Redis:get(Fast..'chdevolper') or "R_N_B1"
function var(value)  
...
---------------------- Dev JABWA ----------------------
if text == 'كيب المجموعه' or text == '/venom' then
...
video = "https://telegra.ph/file/0353c115ccb4b65eec0c4.mp4"
local T =[[
╭──── • ◈ • ────╮
...
keyboard.inline_keyboard = {
{
{text = '✶ اضغط لتنصيب بوتك 💗ˣ.', url = "https://t.me/B72_bot"}
},
{
{text = 'أضغط لاضافه ألبوت لمجموعتك 𖣳', url = "t.me/"..UserBot.."?startgroup=new"},
},
...
if text =='قناة السورس *️⃣' or text =='قناة السورس' or text =='قناه السورس' or text =='قنات السورس' or text =='𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌' then 
Text = [[
[🌀 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙴𝙽𝙾𝙼 𝘳](t.me/RB_RO) 
[☃️𝐃𝐄𝐕 𝐕𝐄𝐍𝐎𝐌](t.me/R_N_B1)
[☃️𝐃𝐄𝐕 ZOZ](t.me/ZzzzOoooozZ)
[☃️𝐃𝐄𝐕 MOSCOW](t.me/U_u_63)
]]
...
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg_chat_id .. '&photo=https://t.me/B_R_R_1/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == '〘 مبرمج السورس 〙' or text == ' ' or text == '' or text == '' or text == '' then  
local UserId_Info = bot.searchPublicChat("")
...
{
{text = '𝑫𝒆𝒗 𝑴𝒆𝒅𝒐', url = "https://t.me/RB_RO"}
},
}
local msg_id = msg.id/2097152/0.5 
...
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/RB_RO"}
},
}
local msg_id = msg.id/2097152/0.5 
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = ' '..UserInfo.first_name..' ', url = 't.me/'..UserInfo.username}, },{{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝐕𝐄𝐍𝐎𝐌', url = 't.me/RB_RO'},},}}
...
local CmdStart = '*\n.. ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ'.. 
'\n🎤╖ أهلآ بك عزيزي أنا بوت '..(Redis:get(Fast.."Name:Bot") or "فينوم")..
